...
storiesOf("InterviewerListItem", module)
  ...
  .add("Form-Edit", () => <Form student="Valentin Lyashenko" interviewer= {3} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
